...
> Vendored from LukasNiessen/kubernetes-skill (KubeShark), MIT License.
> Subset snapshot: `third_party/kubernetes-skill/`.
> Snapshot revision: 34f93c1e409156958cc7c410ab1aa88ab512f10f.
> Omitted upstream CRR files: gke-patterns, aks-patterns, openshift-patterns, gitops-controllers, observability-stacks.

## Lint (this Cursor port)

Static check for manifests/charts is kubeconform (this skill). If the repo already runs it, keep that. Do not add a second YAML schema tool.
