...
> Vendored from antonbabenko/terraform-skill, Apache-2.0,
> Copyright Anton Babenko. Unmodified snapshot:
> `third_party/antonbabenko-terraform-skill/terraform-skill/`.
> Snapshot revision: 0a3a4a66e99001347d36a41e10260a825be3ab62.

## Lint (this Cursor port)

If the repo already has Terraform checks, run them. If bootstrapping, use `terraform fmt` and `terraform validate` (tool defaults). Do not add a second formatter.
