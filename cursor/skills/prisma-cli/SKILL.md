...
> Vendored from Prisma skills (`prisma-cli`), MIT License.
> Unmodified snapshot: `third_party/prisma-skills/prisma-cli/`.
> Snapshot revision: 1123817e60d15ca0f3af91878923241dee7e3b09.

## Lint (this Cursor port)

If the repo already formats/validates Prisma schema, use that. If bootstrapping, run `prisma format` and `prisma validate` (tool defaults).
